...
3. Pull the package into your project by clicking **Packages Get** from the **Flutter Commands** toolbar when the **pubsec.yaml** is open, or select **Toos** > **Flutter** > **Packages Get** from the main menu.
